var express = require('express'),
    ...
    csrf = require('csurf'),
    routes = require('./repo/mongo/routes'),
    api = require('./repo/mongo/routes/api'),
    DB = require('./repo/mongo/lib/accessDB'),
    seeder = require('./repo/mongo/lib/dbSeeder'),
    app = express();

app.set('views', __dirname + '/repo/mongo/views');
